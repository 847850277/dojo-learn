...
pub(crate) async fn decare_event() {
    let path = "/Users/zhengpeng/Work/Source/Code/rust-code/dojo-learn/dojo-starter/target/release/dojo_starter_e_Moved.contract_class.json";
